        ...
        if (v == 1) {
            ...
            if (prom >= 9.5) {
                ...
                System.out.println("""
                                   ...
                                   """);
                System.out.println("El valor de 55 unidades sin descuento es: " + (55 * vunipre) + " con 25% el valor es: " + vdesc);
                ...
                System.out.println("""
                                   ...
                                   """);
                System.out.println("El valor de 50 unidades sin descuento es: " + (50 * vunipre) + " con 10% el valor es: " + vdesc);
                ...
                System.out.println("""
                                   ...
                                   - Acceso a 50 unidades.
                                   """);
                System.out.println("El valor de 50 unidades sin descuento es: " + vdesc);
            } else if (prom <= 7) {
                ...
                if ((mrepro >= 0) && (mrepro <= 3)) {
                    ...
                    System.out.println("""
                                   ...
                                   -45 unidades.
                                   """);
                    System.out.println("El valor de 45 unidades sin descuento es: " + vdesc);
                } else if (mrepro >= 4) {
                    vdesc = vunipre * 40;
                    System.out.println("""
                                   ...
                                   -40 unidades.
                                   """);
                    System.out.println("El valor de 40 unidades sin descuento es: " + vdesc);
                }
